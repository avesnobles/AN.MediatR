...
namespace AN.MediatR.Extensions.Microsoft.DependencyInjection.Tests;
...
public class PipelineTests
{
    ...
    public async Task Should_register_correctly()
    {
        ...
        services.AddSingleton(new AN.MediatR.Tests.PipelineTests.Logger());
        services.AddSingleton(new AN.MediatR.Tests.StreamPipelineTests.Logger());
        services.AddSingleton(new AN.MediatR.Tests.SendTests.Dependency());
